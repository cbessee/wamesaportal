 ...
 * License: MIT
 */
 /* added offset for sidebar class below
 *  to accomodate DanBrady.com sidebar border.
 *  Remove the offset for any other site.
 *  vmf - July 11, 2015
 */
    ...
    b._apply = function(a, f) {
        ...
        d.each(e, function(a, b) {
            ...
            f && 1 >= c.length || (c.each(function() {
                ...
                /* Sidebar offset added fr DanBrady.com. Remove the offset for any other site. vmf - July 11, 2015 */
                if ( a.hasClass('sidebar') ) {
                	a.css("height", e + 30)
                } else {
                	a.css("height", e - b)
                }
