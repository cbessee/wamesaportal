...
class UpdraftPlus_Addons_RemoteStorage_copycom extends UpdraftPlus_RemoteStorage_Addons_Base {
	...
	public function do_bootstrap($opts, $connect = true) {
		...
		// Get the requirements for Copy
		require_once(UPDRAFTPLUS_DIR.'/vendor/autoload.php');
		if (!class_exists('UpdraftPlus_CopyCom_API_WordPress')) require_once(UPDRAFTPLUS_DIR.'/includes/copy/API.php');
