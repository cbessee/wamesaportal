...
class FrmSigAppController{
	...
	public static function create_signature_file( $value, $field, $entry_id ) {
		self::convert_sig_value_to_array( $value );
	 ...
	 * @return string
	 */
	private static function get_final_signature_value( $value, $args ) {
		$sig_value = '';
	...
	/**
	 * Convert the saved signature value to a usable array
	 *
	 * @since 1.07.03
	 * @param $value
	 */
	private static function convert_sig_value_to_array( &$value ){
